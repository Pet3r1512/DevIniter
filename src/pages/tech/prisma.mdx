...
<CodeBlockWithPkg lang="bash" npmCommand="npm prisma generate" pnpmCommand="pnpm prisma generate" />

## Migrations

Then, use Prisma's migration system to create your database schema:

<CodeBlockWithPkg lang="bash" npmCommand="npm prisma migrate dev --name init" pnpmCommand="pnpm prisma migrate dev --name init" />
